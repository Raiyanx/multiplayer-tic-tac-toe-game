**Note:** This project was previously deployed using Heroku. But recently Heroku stopped giving deployment services for free. In future, this project might be deployed using AWS.
